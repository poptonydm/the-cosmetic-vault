export default function About() {
    ...
    return (
      <div className="text-neutral-900 dark:text-neutral-300 bg-neutral-50 dark:bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="max-w-3xl mb-16">
            <h1 className="text-4xl font-bold mb-6">About Luxe & Glow Studio</h1>
            <p className="text-lg text-neutral-700 dark:text-neutral-300 mb-4">
              Founded in Accra, Luxe & Glow Studio was built to make premium beauty accessible and booking stress-free. 
