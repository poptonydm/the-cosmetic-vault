...
export default function ProductDetail() {
  ...
  return (
    <div className='bg-neutral-50 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400'>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <button 
              ...
              className="text-white w-full bg-rose-500 cursor-pointer py-4 rounded-xl font-semibold hover:bg-rose-700 dark:hover:bg-rose-800 transition flex items-center justify-center gap-2"
            >
